...
public class EnemyBlack4Infinite : MonoBehaviour
{
    [SerializeField] List<Sprite> sprites;
    [SerializeField] List<Transform> pathFourWaypoints;
    ...
    public bool allowHit,start,instantiated,pathFour1,pathFour2,pathFour3,pathFour4,pathFour5;
    bool dead;
    void Awake()
    {
        allowHit = true;
    ...
    void Update()
    {
        ...
        if(start) {
            ...
            if(pathFour1) {
            var targetPosition = pathFourWaypoints[waypointIndex].transform.position;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if(other.gameObject.tag == "PlayerLaser" && !dead) {
            ...
            if(hits >= hitsAllowed && !dead) {
                ...
                myAudioSource.PlayOneShot(clip);
                InfiniteInstantiatingManager.pathFourEnemiesDestroyed++;
