...
public class EnemyPathingBlack4 : MonoBehaviour
{
    ...
    [SerializeField] List<Transform> subWaypoints8;
    [SerializeField] List<Transform> subWaypoints9;
    [SerializeField] List<Transform> subWaypoints10;
    [SerializeField] GameObject enemyLaserPrefab;
    [SerializeField] float moveSpeed;
    [SerializeField] float initialMoveSpeed = 17f;
    ...
    public bool reachedDestination,instantiated,fifth1,sixth1,first1,second1,third1,fourth1,first2,second2,third2,fourth2,first3,second3,third3,fourth3;
...
void Start()
        ...
        if(reachedDestination) {
            ...
            if(allowHit && fourth2) {
                ...
                if(subWaypointIndex < 2) {
                    ...
                    var targetPosition2 = new Vector2(subWaypoints10[subWaypointIndex].transform.position.x,subWaypoints10[subWaypointIndex].transform.position.y);
            ...
            if(allowHit && third2) {
                ...
                if(subWaypointIndex < 2) {
                    ...
                    ////Debug.Log(subWaypointIndex);
                    var targetPosition2 = new Vector2(subWaypoints9[subWaypointIndex].transform.position.x,subWaypoints9[subWaypointIndex].transform.position.y);
                    var currentPos = new Vector2(transform.position.x,transform.position.y);
            ...
            if(allowHit && second2) {
                ...
                if(subWaypointIndex < 2) {
                    ...
                    ////Debug.Log(subWaypointIndex);
                    var targetPosition2 = new Vector2(subWaypoints8[subWaypointIndex].transform.position.x,subWaypoints8[subWaypointIndex].transform.position.y);
                    var currentPos = new Vector2(transform.position.x,transform.position.y);
                    //var movementThisFrame2 = moveSpeed * Time.deltaTime * .1f;
                    if(!hit) {
                        transform.position = Vector2.MoveTowards(transform.position,targetPosition2,movementThisFrame2);
    ...
    void EnemyMovementAndFiring() {
        if(EnemyInstantiatingManager.wave4TotalLaunched == 10) {
            reachedDestination = true;
        }

        float movementThisFrame = initialMoveSpeed * Time.deltaTime;
        if(first1) {
            if(waypointIndex < waypoints1.Count) {
                ...
                if(EnemyInstantiatingManager.wave4TotalLaunched == 0) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
                allowHit = true;
        ...
        if(second1) {
            if(waypointIndex < waypoints1.Count - 1) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 1) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(third1) {
            if(waypointIndex < waypoints1.Count - 2) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 2) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(fourth1) {
            if(waypointIndex < waypoints1.Count - 3) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 3) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(fifth1) {
            if(waypointIndex < waypoints1.Count - 4) {
                var targetPosition = waypoints1[waypointIndex].transform.position;
                //var movementThisFrame = moveSpeed * Time.deltaTime;
                if(!hit) {
                    transform.position = Vector2.MoveTowards(transform.position,targetPosition,movementThisFrame);
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 4) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
                if(fourthTimer1 >= fourthTimerCap1 && !hit) {
                    fourthTimer1 = 0f;
        ...
        if(sixth1) {
            if(waypointIndex < waypoints1.Count - 5) {
                var targetPosition = waypoints1[waypointIndex].transform.position;
                //var movementThisFrame = moveSpeed * Time.deltaTime;
                if(!hit) {
                    transform.position = Vector2.MoveTowards(transform.position,targetPosition,movementThisFrame);
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 5) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
                if(fourthTimer1 >= fourthTimerCap1 && !hit) {
                    fourthTimer1 = 0f;
        ...
        if(first2) {
            if(waypointIndex < waypoints2.Count) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 6) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(second2) {
            if(waypointIndex < waypoints2.Count - 1) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 7) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(third2) {
            if(waypointIndex < waypoints2.Count - 2) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 8) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
        ...
        if(fourth2) {
            if(waypointIndex < waypoints2.Count - 3) {
                ...
                allowHit = true;
                if(EnemyInstantiatingManager.wave4TotalLaunched == 9) {
                    EnemyInstantiatingManager.wave4TotalLaunched++;
                }
    ...
    void InitialSetUp() {
        ...
        if(this.gameObject.tag == "enemyBlack") {  
            ...
            //launchPoint2 = this.transform.GetChild(2).gameObject;
            allowHit = false;
            ...
            if(!allowHit) {
                ...
                this.GetComponent<SpriteRenderer>().enabled = false;
                    if(!increasedAlready) {
                        ...
                        EnemyInstantiatingManager.wave4Total++;
                    }
